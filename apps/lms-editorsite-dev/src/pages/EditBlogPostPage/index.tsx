...
import styles from './EditBlogPostPage.module.css';
...
export default function EditBlogPostPage() {
  ...
  useEffect(() => {
    if (!slug) { navigate('/blog-posts'); return; }
    loadEditorPage(slug, 'post')
    ...
    return (
      <div className={styles.page}>
        ...
        <main className={styles.main}>
          ...
          <button className={styles.back} onClick={() => navigate('/blog-posts')}>← Back to posts</button>
        </main>
      </div>
    );
  }
