...
export function WebPagesIcon(): ReactElement {
    return (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="#000" stroke-width=".768" viewBox="0 0 64 64">
  <path d="M39.93 55.72a24.86 24.86 0 1 1 16.93-23.57 37 37 0 0 1-.73 6"/>
